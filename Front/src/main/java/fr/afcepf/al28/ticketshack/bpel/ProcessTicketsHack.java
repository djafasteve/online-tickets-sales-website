 ...
 * 
 */
@WebServiceClient(name = "processTicketsHack", targetNamespace = "http://bpel.ticketshack.al28.afcepf.fr", wsdlLocation = "http://192.168.102.125:9090/ode/processes/processTicketsHack?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.102.125:9090/ode/processes/processTicketsHack?wsdl");
